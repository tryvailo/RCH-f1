    ...
    <section className="py-16 sm:py-24 lg:py-32 bg-[#FDFBF7] overflow-x-hidden">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-centre mb-10 sm:mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            {riskCategories.map((risk, index) => {
              ...
              return (
                ...
                >
                  <div className="flex flex-col items-center text-centre space-y-3 sm:space-y-4">
                    <div
                      className={`w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-xl ${risk.bgClass} flex items-center justify-centre`}
                    >
                      <Icon className={`w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 ${risk.colourClass}`} />
                    </div>
                    <div>
                      <h4 className={`font-bold text-sm sm:text-base lg:text-lg mb-1 sm:mb-2 ${risk.colourClass}`}>
                        {risk.label}
                      </h4>
