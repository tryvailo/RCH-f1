            ...
            return (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-[#4F6F52]/10 flex items-center justify-centre flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
