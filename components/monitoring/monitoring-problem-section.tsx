  ...
  const problems = [
    {
      ...
      description:
        "30% of care homes in the UK are in financial distress. Sudden closure can be devastating for your family. We analyze financial reports to warn you 6-12 months in advance.",
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      description:
        "Official inspections are rare and their results reflect the past. Our AI model analyzes data in real-time to predict future quality of care.",
    },
  ]
