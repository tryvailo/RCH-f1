        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-gradient-to-br from-[#FDFBF7] to-white rounded-2xl border border-[#E8E5DF] shadow-soft-xl overflow-hidden">
            ...
            <div className="grid grid-cols-3 bg-gradient-to-r from-[#4F6F52] to-[#3A5140] text-white">
              ...
              <div className="p-4 sm:p-6 text-center font-bold text-sm sm:text-base border-l border-white/20">
                DIY Research
              </div>
              <div className="p-4 sm:p-6 text-center font-bold text-sm sm:text-base border-l border-white/20 bg-white/10">
                Our Calculator
              </div>
            </div>
            ...
            {comparison.map((row, index) => (
              ...
              >
                ...
                <div className="p-4 sm:p-6 border-l border-[#E8E5DF] text-center">
                  <div className="flex items-center justify-center gap-2 text-[#D17A6F]">
                    <X className="w-5 h-5 flex-shrink-0" strokeWidth={2.5} />
                    <span className="text-xs sm:text-sm">{row.diy}</span>
                  </div>
                </div>
                <div className="p-4 sm:p-6 border-l border-[#E8E5DF] bg-[#7FAD7E]/5 text-center">
                  <div className="flex items-center justify-center gap-2 text-[#4F6F52]">
            ...
            <div className="grid grid-cols-3 bg-gradient-to-r from-[#F5F3EE] to-[#FDFBF7]">
              ...
              <div className="p-4 sm:p-6 border-l border-[#E8E5DF] bg-gradient-to-br from-[#7FAD7E]/10 to-[#4F6F52]/10 text-center">
