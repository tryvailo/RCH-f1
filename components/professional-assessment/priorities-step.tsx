...
import { GripVertical, ChevronUp, ChevronDown, ArrowRight, Check, Info } from "lucide-react"
import { Button } from "@/components/ui/button"
import { BarChart3, PoundSterling, MapPin, Sparkles } from "lucide-react"
...
const defaultPriorities: Priority[] = [
  {
    ...
    description: "CQC ratings, staff stability, care quality, specialisations",
    icon: <BarChart3 className="w-8 h-8 text-[#4F6F52]" />,
  },
  {
    id: "cost_financial",
    title: "Cost & Financial Stability",
    description: "Price stability, hidden fees, value for money, negotiation potential",
    icon: <PoundSterling className="w-8 h-8 text-[#4F6F52]" />,
  },
  {
    id: "location_social",
    title: "Location & Social",
    description: "Distance from family, visiting ease, community, activities",
    icon: <MapPin className="w-8 h-8 text-[#4F6F52]" />,
  },
  {
    id: "comfort_amenities",
    title: "Comfort & Amenities",
    description: "Room quality, facilities, décor, atmosphere, personal touches",
    icon: <Sparkles className="w-8 h-8 text-[#4F6F52]" />,
  },
]

const weights = [40, 30, 20, 10]

export function PrioritiesStep({ onComplete }: PrioritiesStepProps) {
