    ...
    <section id="how-it-works" className="py-16 sm:py-24 lg:py-32 bg-[#FDFBF7] overflow-x-hidden">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-16 space-y-3 sm:space-y-4">
          ...
          <p className="text-base sm:text-lg md:text-xl text-[#1A231E]/70">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-10 md:gap-12 relative">
            ...
            <div
              className="hidden md:block absolute top-12 left-0 right-0 h-px bg-[#E8E5DF] z-0"
                ...
                <div key={step.number} className="relative z-10">
                  <div className="flex flex-col items-center text-center space-y-5 sm:space-y-6">
                    ...
                    <div className="space-y-2">
                      <h3 className="text-xl sm:text-2xl font-bold text-[#1A231E]">
                        {step.number}. {step.title}
                      </h3>
                      <p className="text-base sm:text-lg text-[#1A231E]/70 leading-relaxed max-w-xs mx-auto">
                        {step.description}
                      </p>
                    </div>
                  </div>
