...
const neighborhoods = [
  ...
  },
  {
    ...
    avgCost: "£1,320",
    avgRating: 4.2,
    highlight: "Excellent facilities",
  },
  {
    name: "Harborne",
    homes: 28,
...
export function BirminghamCareHomesSection() {
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
            We've analyzed every care home across Birmingham's neighborhoods to help you find the perfect location
          </p>
        </div>
        ...
        <div className="mt-12 max-w-3xl mx-auto bg-primary/5 border-2 border-primary/20 rounded-2xl p-8">
          <div className="flex items-start gap-4">
            ...
            <div className="space-y-2">
              <h3 className="text-xl font-serif font-bold text-foreground">All 277 Homes Verified</h3>
              <p className="text-base text-muted-foreground leading-relaxed">
                Every care home in our Birmingham database has been verified against CQC records, with up-to-date
