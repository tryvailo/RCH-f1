      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center space-y-4 mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-4 max-w-2xl mx-auto mb-12">
            <div className="rounded-xl border-2 border-[#E8E5DF] bg-white p-4 text-center">
            ...
            <div className="rounded-xl border-2 border-[#4F6F52] bg-gradient-to-br from-[#4F6F52]/5 to-[#7FAD7E]/5 p-4 text-center ring-1 ring-[#4F6F52]/20">
            ...
            {reportSections.map((section, index) => (
              ...
              >
                <div className="flex items-start gap-4 mb-4">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#4F6F52] to-[#3A5140] flex items-center justify-center flex-shrink-0 shadow-soft-md">
