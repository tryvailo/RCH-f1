...
export const metadata: Metadata = {
  title: "Professional Thank You Preview | RightCareHome",
  description: "Preview of professional assessment thank you page",
}

export default function PreviewProThankYou() {
  const reference = "PRO-2024-12345"
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-[#7FAD7E]/10 to-[#4F6F52]/10 rounded-2xl p-5 sm:p-6 mb-6 sm:mb-8 border border-[#4F6F52]/20">
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            <div className="bg-white/60 backdrop-blur rounded-xl p-3 sm:p-4 border border-[#4F6F52]/10">
              <div className="text-2xl sm:text-3xl font-bold text-[#4F6F52] mb-1">206</div>
              <div className="text-sm sm:text-base text-[#1A231E]/70">Data Points per Home</div>
            </div>
            <div className="bg-white/60 backdrop-blur rounded-xl p-3 sm:p-4 border border-[#4F6F52]/10">
              <div className="text-2xl sm:text-3xl font-bold text-[#4F6F52] mb-1">15+</div>
              <div className="text-sm sm:text-base text-[#1A231E]/70">Independent Sources</div>
            </div>
            <div className="bg-white/60 backdrop-blur rounded-xl p-3 sm:p-4 border border-[#4F6F52]/10">
              <div className="text-2xl sm:text-3xl font-bold text-[#4F6F52] mb-1">3-5</div>
              <div className="text-sm sm:text-base text-[#1A231E]/70">Homes Analysed</div>
            </div>
            <div className="bg-white/60 backdrop-blur rounded-xl p-3 sm:p-4 border border-[#4F6F52]/10">
              <div className="text-2xl sm:text-3xl font-bold text-[#4F6F52] mb-1">800+</div>
        ...
        {/* What Happens Next */}
        <div className="bg-white rounded-2xl sm:rounded-3xl border border-[#E8E5DF] shadow-sm p-5 sm:p-6 lg:p-8 mb-6 sm:mb-8">
