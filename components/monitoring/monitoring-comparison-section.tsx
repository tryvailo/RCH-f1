      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-gradient-to-br from-[#FDFBF7] to-white rounded-2xl shadow-soft-xl border border-[#E8E5DF] overflow-hidden">
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b-2 border-[#E8E5DF]">
                    ...
                    <th className="text-centre p-6 w-1/3">
                    ...
                    <th className="text-centre p-6 w-1/3 bg-gradient-to-br from-[#4F6F52]/5 to-[#4F6F52]/10">
                      <div className="space-y-2">
                ...
                <tbody>
                  {comparison.map((item, index) => (
                    <tr key={index} className="border-b border-[#E8E5DF] hover:bg-[#FDFBF7]/50 transition-colours">
                      <td className="p-6 font-medium text-[#1A231E]">{item.feature}</td>
                      <td className="p-6 text-centre">
                      ...
                      <td className="p-6 text-centre bg-gradient-to-br from-[#4F6F52]/5 to-[#4F6F52]/10">
            ...
            <div className="bg-gradient-to-r from-[#4F6F52] to-[#3A5140] p-8 text-centre">
